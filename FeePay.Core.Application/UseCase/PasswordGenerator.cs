...
namespace FeePay.Core.Application.UseCase
{
    public class PasswordGenerator : IPasswordGenerator
    {
            ...
            int minimumSpecialChars = 1)
        {
            ...
            {
                throw new ArgumentException("The minimumlength is smaller than 8.",
            ...
            {
                throw new ArgumentException("The minimumLowerCase is smaller than 1.",
                    "minimumLowerCaseChars");
            }

            if (minimumUpperCaseChars < 1)
            {
                throw new ArgumentException("The minimumUpperCase is smaller than 1.",
                    "minimumUpperCaseChars");
            }

            if (minimumNumericChars < 1)
            {
                throw new ArgumentException("The minimumNumeric is smaller than 1.",
                    "minimumNumericChars");
            }

            if (minimumSpecialChars < 1)
            {
                throw new ArgumentException("The minimumSpecial is smaller than 1.",
                    "minimumSpecialChars");
            }
