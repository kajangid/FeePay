...
-- Description:	Sp to add student admission form data 
-- =============================================
	...
	BEGIN
		...
		INSERT 
			INTO [dbo].[StudentAdmission]
				   ...
				   ,[GuardianMobileNo],[Sr_RegNo],[EnrollNo],[MACHINEID],[PreviousClass],[PreviousInstituteName],[YearOfPassing],[PreviousRollNo]
