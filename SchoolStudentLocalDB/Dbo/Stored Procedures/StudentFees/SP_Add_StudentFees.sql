	...
	BEGIN
		...
		INSERT 
			INTO [dbo].[StudentFees]
				   ([StudentAdmissionId],[AcademicSessionId],[FeeMasterId],[FeeGroupId],
				   [IsPaid],[IsActive],[IsDelete],[AddedDate],[ModifyDate],[AddedBy])
			 VALUES
				   (@StudentAdmissionId,@AcademicSessionId,@FeeMasterId,@FeeGroupId,
				   @IsPaid,@IsActive,0,GETDATE(),GETDATE(),@AddedBy)
