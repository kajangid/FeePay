...
-- Description:	Sp to get fee master list data with add edit user data
-- =============================================
CREATE PROCEDURE [dbo].[SP_GetAll_FeeMaster_AddEditUser]
(
@Id INT = 0
,@FeeGroupId INT = NULL
,@FeeTypeId INT = NULL
...
BEGIN	
	...
	SELECT  
		...
		[fm].[IsDelete], [fm].[ModifyDate], [fm].[AddedDate]
